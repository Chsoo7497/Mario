...
void CNomalBlock::Time_Update(float deltaTime)
{
	//m_ftime += deltaTime;
	//if (m_ftime > 0.2f) {
	//	m_icount++;
...
void CNomalBlock::Update()
{
}

void CNomalBlock::Render(HDC hDC, Coordi Scroll)
{
	//1+17*i,23+17*j
	HDC hBlock = CImageManager::Get_Instance()->Find_Sheet(CImageMap::sheet::Tile, 103, 23, 16, 16);
...
USHORT CNomalBlock::Collision(CObject* other)
{
	USHORT Collision = 0;
	if (m_bTop)
